...
public interface ClothRepository extends JpaRepository<Cloth, Long> {
    // 1. wearNum 오름차순
    Page<Cloth> findByMemberOrderByWearNumberAsc(Member member, Pageable pageable);

    // 2. wearNum 내림차순
    Page<Cloth> findByMemberOrderByWearNumberDesc(Member member, Pageable pageable);

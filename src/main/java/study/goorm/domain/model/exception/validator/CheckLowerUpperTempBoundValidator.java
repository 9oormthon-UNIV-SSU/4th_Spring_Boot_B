...
public class CheckLowerUpperTempBoundValidator implements ConstraintValidator<CheckLowerUpperTempBound, ClothRequestDTO.ClothCreateDTO> {
    ...
    @Override
    public boolean isValid(ClothRequestDTO.ClothCreateDTO request, ConstraintValidatorContext context) {
